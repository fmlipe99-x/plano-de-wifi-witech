...
mbQuantidade = int(input(f"Quantos megabytes voce pretende assinar? preco do megabyte = {(PRECO_MB)} reais : "))
...
print(f" voce precira de {preco_total} para assinar o plano")

dinheiroQuantidade = float(input("Quantos reais voce tem para assinar o plano?: "))

if dinheiroQuantidade >= preco_total:
